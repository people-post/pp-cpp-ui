...
The UI engine in this repository started as a hard fork of [pp-cpp-ui](https://github.com/mikke89/pp-cpp-ui) **6.2**
...
- Sources live under `include/ui/` and `src/{core,svg,debugger}/` as owned code.
