...
#include <string.h>
	...
	#define UI_SHADER_HEADER_VERSION "#version 300 es\nprecision highp float;\n"
	#include <GLES3/gl3.h>
#elif defined __ANDROID__
	#define UI_SHADER_HEADER_VERSION "#version 320 es\nprecision highp float;\n"
	#include <GLES3/gl32.h>
#elif defined UI_GL3_CUSTOM_LOADER
	#define UI_SHADER_HEADER_VERSION "#version 330\n"
...
{
#if defined(UI_PLATFORM_EMSCRIPTEN) || defined(__ANDROID__)
...
{
#if !defined(UI_PLATFORM_EMSCRIPTEN) && !defined(__ANDROID__) && !defined(UI_GL3_CUSTOM_LOADER)
	gladLoaderUnloadGL();
#endif
}
