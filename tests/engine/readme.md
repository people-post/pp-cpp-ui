## pp-cpp-ui Test Suite

This directory contains tests and benchmarks for pp-cpp-ui. They have been separated into three projects located under the `Source` directory. These projects can be enabled using the CMake options `BUILD_TESTING`, and built using the CMake targets below.

#### Visual tests: `ui_visual_tests`
...
|----------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `UI_VISUAL_TESTS_RML_DIRECTORIES`   | Additional directories containing `*.rml` test documents. Separate multiple directories by comma. Change test suite directory using `Up`/`Down` arrow keys. |
| `UI_VISUAL_TESTS_COMPARE_DIRECTORY` | Input directory for screenshot comparisons.                                                                                                                 |
| `UI_VISUAL_TESTS_CAPTURE_DIRECTORY` | Output directory for generated screenshots.                                                                                                                 |
...
By default, the visual tests will store screenshots and other outputs into this directory, and read previous screenshots from this directory. To specify other directories, use the environment variables options `UI_VISUAL_TESTS_CAPTURE_DIRECTORY` and `UI_VISUAL_TESTS_COMPARE_DIRECTORY` as described above.
