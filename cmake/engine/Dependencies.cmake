#[[
	Set up external dependencies required to build pp-cpp-ui itself.
...
if(UI_FONT_ENGINE STREQUAL "freetype")
...
if(UI_LUA_BINDINGS AND (UI_LUA_BINDINGS_LIBRARY STREQUAL "lua" OR UI_LUA_BINDINGS_LIBRARY STREQUAL "lua_as_cxx"))
	...
	add_library(ui::External::Lua ALIAS Lua::Lua)
	set(friendly_message "Lua bindings enabled")
	if(UI_LUA_BINDINGS_LIBRARY STREQUAL "lua_as_cxx")
...
if(UI_LUA_BINDINGS AND UI_LUA_BINDINGS_LIBRARY STREQUAL "luajit")
	...
	add_library(ui::External::Lua ALIAS LuaJIT::LuaJIT)
	report_dependency_found_or_error("Lua" "LuaJIT" LuaJIT::LuaJIT "Lua bindings enabled with LuaJIT")
endif()

if(NOT UI_IS_CONFIG_FILE)
	if(UI_TRACY_PROFILING AND UI_TRACY_CONFIGURATION)
...
if(UI_HARFBUZZ_SAMPLE)
	if(NOT UI_FONT_ENGINE STREQUAL "freetype")
		message(FATAL_ERROR "The HarfBuzz sample requires the default (FreeType) font engine to be enabled. Please set UI_FONT_ENGINE accordingly or disable UI_HARFBUZZ_SAMPLE.")
	endif()
